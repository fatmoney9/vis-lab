...
| `charts/core/` | L1 | 跨图表共享构件：轴、网格、图例、tooltip、缩放轴、水印、数据标签、比例尺、格式化 |
...
| [specs/](specs/) | 各规范条目：[坐标轴](specs/axes.md) · [柱](specs/bar.md) · [折线](specs/line.md) · [颜色](specs/color.md) · [图例](specs/legend.md) · [浮层](specs/tooltip.md) · [数值格式](specs/format.md) · [缩放轴](specs/datazoom.md) · [水印](specs/watermark.md) · [数据标签](specs/data-label.md) |
