...
| <http://localhost:8123/playground/preview.html> | **开发验收面**：三主题横向并排、旋钮更全、卡片可拖拽 |
...
| [specs/](specs/) | 各规范条目：[坐标轴](specs/axes.md) · [轴标题](specs/axis-title.md) · [柱](specs/bar.md) · [折线](specs/line.md) · [饼环](specs/pie.md) · [颜色](specs/color.md) · [图例](specs/legend.md) · [浮层](specs/tooltip.md) · [数值格式](specs/format.md) · [缩放轴](specs/datazoom.md) · [水印](specs/watermark.md) · [数据标签](specs/data-label.md) · [动效](specs/motion.md) |
