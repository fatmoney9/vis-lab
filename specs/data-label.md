...
`playground/cartesian-preview.html`（右栏 **数据标签** 旋钮 = `dataLabel` 三态）：
...
- [ ] 饼 / 环外侧标签（`color-text-primary` + 引线跟随扇区色，见 [color.md](color.md)）与横向条形图右侧标签（`size-hbar-data-label-max` 40px 已备好）——待各自 L2 骨架。
